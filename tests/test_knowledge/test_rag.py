...
def mock_qdrant_client():
    with patch('app.vector_store.vector_store.QdrantClient') as mock_client:
...
@patch('app.vector_store.vector_store.embed_texts')
@patch('app.vector_store.vector_store.embed_text')
